...
import { FiEdit3, FiClipboard, FiUsers, FiSettings, FiLogOut } from "react-icons/fi";
...
const UserSidebar = () => {
    ...
    const navItems = [
        { path: "/submit-complaint", label: "Submit Complaint", icon: <FiEdit3 size={20} /> },
        { path: "/complaints", label: "My Complaints", icon: <FiClipboard size={20} /> },
        { path: "/community", label: "Community View", icon: <FiUsers size={20} /> },
